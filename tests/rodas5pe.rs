use differential_equations::{CallbackAction, OdeProblem, Rodas5Pe, SaveMode, SolveOptions, solve};
...
#[test]
fn rodas5pe_fixed_and_adaptive_orders_match_fifth_order_primary() {
    ...
    let fixed = solve(&problem, Rodas5Pe, &fixed_options(0.125)).unwrap();
...
#[test]
fn rodas5pe_supports_backward_jacobian_callback_and_save_at() {
