...
- In-scope regular ODE names: **345**
  ...
  12 public aliases).
- Implemented and detected in matched Julia tests: **103**.
- Missing in-scope public names: **242**.
...
| Rosenbrock and Rosenbrock-W | 40 | 11 | 29 |
...
### Rosenbrock and Rosenbrock-W (29)
