...
- In-scope regular ODE names: **345**
  ...
  12 public aliases).
- Implemented and detected in matched Julia tests: **110**.
- Missing in-scope public names: **235**.
...
| Rosenbrock and Rosenbrock-W | 40 | 17 | 23 |
...
### Rosenbrock and Rosenbrock-W (23)
