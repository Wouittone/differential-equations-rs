...
- In-scope regular ODE names: **345**
  ...
  12 public aliases).
- Implemented and detected in matched Julia tests: **104**.
- Missing in-scope public names: **241**.
...
| Rosenbrock and Rosenbrock-W | 40 | 12 | 28 |
...
### Rosenbrock and Rosenbrock-W (28)
