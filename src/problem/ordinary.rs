...
use super::{OdeProblem, StepInterpolator};
use crate::SolveError;
use crate::callback::{
    Callback, CallbackAction, CallbackOutcome, CallbackSave, CallbackSet, ContinuousCallback,
    DiscreteCallback, DiscreteTrigger, EventCrossing, EventDirection, PresetTimes,
    VectorContinuousCallback,
};
use crate::event::effective_event_tolerance;
use ndarray::{ArrayViewD, ArrayViewMut1, ArrayViewMut2, ArrayViewMutD, Dimension, IxDyn};
